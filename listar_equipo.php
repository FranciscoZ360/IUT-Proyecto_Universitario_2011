...
try {
	...
	$respuesta = $equipo->listar($inicio);}
...
<table width="800" height="570" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <center><font face="calibri">
      <p><h2><font face="calibri">Listado de Equipos</h2></p></center>
    <table width="100%"  border="0" align="center">
      <tr>
        <td width="155" align="left" bgcolor="#EAEAEA">Descripcion</td>
        <td width="125" align="left" bgcolor="#DBDBDB">Marca</td>
        <td width="129" align="left" bgcolor="#EAEAEA">Serial</td>
        <td width="85" align="left" bgcolor="#DBDBDB">Status</td>
        <td width="80" align="center" bgcolor="#EAEAEA">Opciones</td>
      </tr>
      <?php 
  ...
  for ($i=0; $i<$total; $i++) {
      ...
      <tr>
        ...
        <td bgcolor="#DBDBDB"><?php echo $fila['status']; ?> </td>
        <td width="80" align="center" bgcolor="#EAEAEA"> <a href="editar_equipo.php?id_equipo=<?php echo $fila['id_equipo']; ?>"> <img src="img/b_edit.png" alt="modificar" width="16" height="16" border="0" /></a></td>
      </tr>
      <?php }?>
    </table>
