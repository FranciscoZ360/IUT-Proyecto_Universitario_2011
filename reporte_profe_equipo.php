...
<table width="800" height="570" border="0" cellspacing="0" cellpadding="0" align="center" >
  ...
  <tr>
    ...
    <td width="620" table style="background:url('img/Fondo-2.jpg') no-repeat bottom center" valign="top" id="enviar"><form id="form1" name="form1" method="post" onSubmit="return validar_campos(this)"action="reProEquipo.php">
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
      <td align="center"><h3>Reporte de Prestamo de Equipo por <font face="calibri">Profesor</font></h3>
        <p>&nbsp;</p></td>
      </tr>
      <tr>
      <td align="center">
        <p>
          <label>
            <font face="calibri">Cedula Profesor:</font> 
            <input name="cedula" type="text" id="cedula" size="25" maxlength="8" />
          </label>
        </p>
        <p>&nbsp;</p></td>
      </tr>
