...
<table width="800" height="570" border="0" cellspacing="0" cellpadding="0" align="center" >
  ...
  <tr>
    ...
    <td width="620" table style="background:url('img/Fondo-2.jpg') no-repeat bottom center" valign="top"><form id="form1" name="form1" method="post" action="reFechEquipo.php">
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr>
      <td align="center"><h3>Reporte de Prestamo de Equipo por Fecha</h3>
        <p>&nbsp;</p></td>
      </tr>
      <tr>
      <td align="center">
