...
$cedula = $_POST['cedula'];
$reg = $material->EntregaProfesor($cedula);
...
<table width="800"  height="570" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <center><h2>Reporte de entrega de materiales por profesor</h2></center>
      <tr>
      <tr>
      Profesor : <?php echo $reg[0][0]." ".$reg[0][1]; ?>
      </tr>
        <td width="220" align="left" bgcolor="#DBDBDB"><font face="calibri">Material</font></td>
        <td width="145" align="left" bgcolor="#EAEAEA"><font face="calibri">Cantidad</font></td>
        <td width="241" align="left" bgcolor="#DBDBDB">Fecha entrega</td>
        </tr>
      <?php 
  ...
  $total=count($reg);
      ...
      <tr>
        ...
        <td bgcolor="#DBDBDB"><?php $fecha=$reg[$i]['fecha_entrega'];
    ...
    <table width="100%" height="104" border="0" align="center">
      <tr>
        <td width="50%" height="32" align="left"> 
        <?php 
			if ($inicio!=0) {
		?>
        <a href="reProMaterial.php?reg=<?php echo $inicio - 10; ?>"><input type="button" name="Anterior" id="Anterior" value="Anterior" /></a>
        <?php } ?>
        </td>
		...
		?>
        <a href="reProMaterial.php?reg=<?php echo $inicio; ?>"><input type="button" name="Siguiente" id="Siguiente" value="Siguiente" /></a>
        <?php } ?>
        </td>
        </tr>
      <tr>
        <td height="32" colspan="2" align="center"><input type="reset" name="Imprimir" id="Imprimir" value="imprimir" onclick= "window.print();"/></td>
        </tr>
      </table>
    </form>
    </td>
